                ...
                {products.map((p, i) => (
                  ...
                  >
                    <div className="relative overflow-hidden">
                      ...
                      />
                      <div className="absolute top-3 left-3 bg-[#7B1F8A] text-white text-[10px] px-3 py-1 rounded-full tracking-wide">
                        {p.category}
                      </div>
                      <div className="absolute inset-0 bg-[#7B1F8A]/0 group-hover:bg-[#7B1F8A]/10 transition-all flex items-center justify-center">
                        <span className="text-white text-xs font-medium opacity-0 group-hover:opacity-100 transition-all bg-[#7B1F8A] px-4 py-2 rounded-full shadow">
                          View Details
                        </span>
                      </div>
                    </div>
                    <div className="p-5">
                      <h3
                        style={{ fontFamily: "'Playfair Display', serif" }}
                        className="font-semibold text-lg text-[#3a0f45] mb-1 truncate"
                      >
                        {p.title}
                      </h3>
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          {p.mrp > 0 && (
                            <span className="text-[#7B1F8A] text-xs font-semibold">
                              ₹{p.mrp}
                            </span>
                          )}
