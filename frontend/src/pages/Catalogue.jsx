      ...
      <div className="pt-16" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <section className="relative min-h-[55vh] flex items-center justify-center text-white bg-cover bg-center"
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif" }} className="text-4xl md:text-6xl font-bold">
              Product Catalogues
            </h1>
            <div className="w-12 h-0.5 bg-[#C9A84C] mx-auto" />
            <p className="text-white/75 text-sm">Download our product catalogues for detailed specifications</p>
          </motion.div>
        </section>
        ...
        <motion.section variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-10">
              <p className="text-[#C9A84C] uppercase tracking-widest text-xs font-medium mb-2">Downloads</p>
            ...
            {/* Loading */}
            {loading && (
              <div className="text-center py-20 text-gray-400 text-sm">Loading catalogues...</div>
            )}
            ...
            {!loading && catalogues.length === 0 && (
              <div className="text-center py-20 text-gray-400 border-2 border-dashed rounded-2xl">
                ...
                <p className="text-sm font-medium">No catalogues available yet.</p>
              </div>
            )}
